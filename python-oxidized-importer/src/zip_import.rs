...
impl OxidizedZipFinder {
    ...
    #[classmethod]
    #[allow(unused)]
    fn from_path<'p>(cls: &Bound<'p, PyType>, py: Python, path: &Bound<'p, PyAny>) -> PyResult<Self> {
    ...
    #[allow(unused)]
    fn create_module<'p>(&self, py: Python, spec: &Bound<'p, PyAny>) -> PyResult<Py<PyAny>> {
